...
$sql = "SELECT id, subject, name, email, bus_number, classification, status, date_submitted FROM complaints";
      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            ...
            <li class="active"><a href="complaint.php">Complaint <br> Management</a></li>
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<tr data-id='{$row['id']}'>
                                ...
                                <td>" . htmlspecialchars($row['bus_number'], ENT_QUOTES, 'UTF-8') . "</td>
                                <td>" . htmlspecialchars($row['subject'], ENT_QUOTES, 'UTF-8') . "</td>
                                <td>" . htmlspecialchars($row['classification'], ENT_QUOTES, 'UTF-8') . "</td>
                                <td class='status'>" . htmlspecialchars($row['date_submitted'], ENT_QUOTES, 'UTF-8') . "</td>
                                <td>" . htmlspecialchars($row['status'], ENT_QUOTES, 'UTF-8') . "</td>
                                <td>
                                    <button class='btn btn-primary' onclick='openDetailsModal(`$complaintJson`)'>View Details</button>
                                    <button class='btn btn-warning' onclick='toggleStatus(this)'>Change Status</button>
                                </td>
                              </tr>";
                    }
                } else {
...
<script>
    function openDetailsModal(busJson) {
        try {
            ...
            document.getElementById("modalBusNumber").textContent = busData.bus_number || "N/A";
