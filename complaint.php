                ...
                ?>
                          <tr data-id="<?php echo htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8'); ?>">
                              ...
                              <td>
                                  ...
                                  ?>
                                  <span style="<?php echo $statusColor; ?> border-radius: 8px; padding: 8px 16px; font-size: 14px; display: inline-flex; justify-content: center; align-items: center; min-width: 100px;">
