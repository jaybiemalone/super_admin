...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['update_status'])) {
    ...
    $update_query = "UPDATE maintenance SET status='$new_status' WHERE id=$id";
    $conn->query($update_query);
  } elseif (isset($_POST['update_update'])) {
    $new_update = $_POST['update'];
    $update_query = "UPDATE maintenance SET `update`='$new_update' WHERE id=$id";
    $conn->query($update_query);
  }
              ...
              <td>
                <form method="post">
                  ...
                  <select name="status">
                    ...
                    <option value="Resolve" <?php if ($row['status'] == 'Resolve')
                      echo 'selected'; ?>>Resolve</option>
                  </select>
                  <button type="submit" name="update_status">Update Status</button>
                </form>
              </td>
              <!-- Update Field (with a button) -->
              <td>
                <form method="post">
                  <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                  <select name="update">
