...
<head>
  ...
  <style>
        ...
        .pagination a { text-decoration: none; padding: 8px 12px; border: 1px solid black; margin: 5px; }
...
<body>
  ...
  <main>
    ...
    <div>
    <button id="openModal">Add Employee</button>
    ...
    <table id="userTable" class="display">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $newStatus = ($status == 'active') ? 'disabled' : 'active';
