...
$compliance_query = "SELECT COUNT(*) as total FROM compliance_data";
$incidents_query = "SELECT COUNT(*) as total FROM accident_reports";
...
$complaints_count = $complaints_result->fetch_assoc()['total'];
$compliance_count = $compliance_result->fetch_assoc()['total'];
$incidents_count = $incidents_result->fetch_assoc()['total'];
  ...
  <nav id="sidebar">
    <ul>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            <li class="active"><a href="legal.php">Legal <br> Overview</a></li>
  ...
  <main>
    <div class="legal-container">
        ...
        <div class="card-container">
            ...
            <div class="card">
              <ul>
                <li><img src="./icons/loud-speaker.png" alt="Loud Speaker Icon" width="40"></li>
                <li><h2>Total Complaints</h2></li>
                <li><span><?php echo $complaints_count; ?></span></li>
                <li><a href="complaint.php">More Info</a></li>
              </ul>
            </div>
            <div class="card">
              <ul>
                ...
                <li><span><?php echo $compliance_count; ?></span></li>
                <li><a href="compliance.php">More Info</a></li>
              </ul>
            </div>
            <div class="card">
              <ul>
                ...
                <li><span><?php echo $incidents_count; ?></span></li>
                <li><a href="safety.php">More Info</a></li>
              </ul>
            </div>
            
        <div class="legal-graph">
          <div class="d-flex justify-content-between align-items-center mb-4">
              <h4 class="fw-bold">Accident Trends (2025)</h4>
          </div>
          ...
          <div class="chart-container shadow-sm rounded-lg p-3 border mt-3" style="position: relative; height: 300px;">
